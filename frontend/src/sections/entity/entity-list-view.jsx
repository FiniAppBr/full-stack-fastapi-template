...
export function EntityListView() {
  ...
  return (
    <DashboardContent maxWidth="xl">
      ...
      {/* Template Selection Dialog - key resets state when category changes */}
      <TemplateSelectionDialog
        key={selectedCategoryForNew}
...
function TemplateSelectionDialog({ open, onClose, onSelect, preselectedCategory }) {
  // Use preselectedCategory directly as initial value; parent resets via key prop on dialog
